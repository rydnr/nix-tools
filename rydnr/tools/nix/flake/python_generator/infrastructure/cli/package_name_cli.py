...
"""
rydnr/tools/nix/flake/python_generator/infrastructure/cli/package_name_cli.py

This file defines the PackageNameCli class.
...
class PackageNameCli(CliHandler, PrimaryPort):

    """
    A PrimaryPort used to get the name of the desired Python package from the CLI.

    Class name: PackageNameCli

    Responsibilities:
        - Parse the command-line to retrieve the information about the name of the Python package.
    ...
    def __init__(self):
        """
        Creates a new PackageNameCli instance.
        """
        super().__init__("The name of the Python package")
    ...
    async def handle(self, app: PythonEDA, args):
        ...
        if args.package_name:
            await app.accept_package_name(args.package_name)
